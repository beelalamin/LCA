    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            Forms\Components\Tabs::make('asset_tabs')
                ->columnSpanFull()
                ->tabs([
                    Forms\Components\Tabs\Tab::make(__('Identification'))->schema([
                    ...
                    Forms\Components\Tabs\Tab::make(__('Specs'))->schema([
                        Forms\Components\Grid::make(2)->schema([
                    ...
                    Forms\Components\Tabs\Tab::make(__('Financial & Warranty'))->schema([
                        Forms\Components\Grid::make(2)->schema([
                            ...
                            Forms\Components\Select::make('warranty_status_id')
                                ...
                                ->options(fn () => static::lookupOptions(WarrantyStatus::class))
                                ->searchable(),
                    ...
                    Forms\Components\Tabs\Tab::make(__('Location'))->schema([
                        Forms\Components\Grid::make(2)->schema([
                    ...
                    Forms\Components\Tabs\Tab::make(__('Assignment'))->schema([
                        Forms\Components\Grid::make(2)->schema([
                    ...
                    Forms\Components\Tabs\Tab::make(__('Maintenance'))->schema([
                        Forms\Components\Grid::make(2)->schema([
                    ...
                    Forms\Components\Tabs\Tab::make(__('Disposal'))->schema([
                        Forms\Components\Grid::make(2)->schema([
        ...
        return $infolist->schema([
            ...
            ISection::make(__('Current Assignment'))->schema([
                IGrid::make(3)->schema([
                    ...
                    TextEntry::make('assigned_date')->label(__('Assigned Date'))->date(),
                    TextEntry::make('return_date')->label(__('Return Date'))->date(),
                ]),
            ]),

            ISection::make(__('Maintenance'))->schema([
                IGrid::make(3)->schema([
                    TextEntry::make('maintenanceStatus.code')->label(__('Maintenance Status'))
                        ->formatStateUsing(fn ($state, $record) => $record->maintenanceStatus?->getTranslatedName()),
                    TextEntry::make('maintenanceType.code')->label(__('Maintenance Type'))
                        ->formatStateUsing(fn ($state, $record) => $record->maintenanceType?->getTranslatedName()),
                    TextEntry::make('last_maintenance_date')->label(__('Last Maintenance'))->date(),
                    TextEntry::make('next_maintenance_date')->label(__('Next Maintenance'))->date(),
                ]),
            ])->collapsed(),

            ISection::make(__('Disposal'))->schema([
                IGrid::make(3)->schema([
                    TextEntry::make('disposal_date')->label(__('Disposal Date'))->date(),
                    TextEntry::make('disposalMethod.code')->label(__('Disposal Method'))
                        ->formatStateUsing(fn ($state, $record) => $record->disposalMethod?->getTranslatedName()),
                    TextEntry::make('disposalReason.code')->label(__('Disposal Reason'))
                        ->formatStateUsing(fn ($state, $record) => $record->disposalReason?->getTranslatedName()),
                ]),
            ])->collapsed(),
